module Mandrill
  ...
  class Templates
    ...
    def add(name, from_email=nil, from_name=nil, subject=nil, code=nil, text=nil, publish=true, &block)
      _params = {:name => name, :from_email => from_email, :from_name => from_name, :subject => subject, :code => code, :text => text, :publish => publish}
      if block_given?
        @master.call 'templates/add', _params, &block
      else
    ...
    def info(name, &block)
      _params = {:name => name}
      if block_given?
        @master.call 'templates/info', _params, &block
      else
    ...
    #     - [String] created_at the date and time the template was first created as a UTC string in YYYY-MM-DD HH:MM:SS format
    #     - [String] updated_at the date and time the template was last modified as a UTC string in YYYY-MM-DD HH:MM:SS format
    def update(name, from_email=nil, from_name=nil, subject=nil, code=nil, text=nil, publish=true, &block)
      _params = {:name => name, :from_email => from_email, :from_name => from_name, :subject => subject, :code => code, :text => text, :publish => publish}
      if block_given?
        @master.call 'templates/update', _params, &block
      else
        @master.call 'templates/update', _param
      end
    ...
    def publish(name, &block)
      _params = {:name => name}
      if block_given?
        @master.call 'templates/publish', _params, &block
      else
    ...
    def delete(name,&block)
      _params = {:name => name}
      if block_given?
        @master.call 'templates/delete', _param, &block
      else
        @master.call 'templates/delete', _param
      end
    ...
    def list(&block)
      _params = {}
      if block_given?
        @master.call 'templates/list', _params, &block
      else
    ...
    def time_series(name, &block)
      _params = {:name => name}
      if block_given?
        @master.call 'templates/time-series', _params, &block
      else
    ...
    def render(template_name, template_content, merge_vars=nil, &block)
      _params = {:template_name => template_name, :template_content => template_content, :merge_vars => merge_vars}
      if block_given?
        @master.call 'templates/render', _params, &block
      else
  ...
  class Exports
    ...
    def info(id, &block)
      _params = {:id => id}
      if block_given?
        @master.call 'exports/info', _params, &block
      else
    ...
    def list( &block)
      _params = {}
      if block_given?
        @master.call 'exports/list', _params, &block
      else
    ...
    def rejects(notify_email=nil, &block)
      _params = {:notify_email => notify_email}
      if block_given?
        @master.call 'exports/rejects', _params, &block
      else
    ...
    #     - [String] state the export job's state
    #     - [String] result_url the url for the export job's results, if the job is complete
    def whitelist(notify_email=nil, &block)
      _params = {:notify_email => notify_email}
      if block_given?
        @master.call 'exports/whitelist', _params, &block
      else
    ...
    #     - [String] state the export job's state
    #     - [String] result_url the url for the export job's results, if the job is complete
    def activity(notify_email=nil, date_from=nil, date_to=nil, tags=nil, senders=nil, states=nil, &block)
      _params = {:notify_email => notify_email, :date_from => date_from, :date_to => date_to, :tags => tags, :senders => senders, :states => states}
      if block_given?
        @master.call 'exports/activity', _params, &block
      else
  ...
  class Users
    ...
    def info( &block)
      _params = {}
      if block_given?
        @master.call 'users/info', _params, &block
      else
    ...
    def ping(&block)
      _params = {}
      if block_given?
        @master.call('users/ping2', _params, &block)
      else
    ...
    def senders( &block)
      _params = {}
      if block_given?
        @master.call 'users/senders', _params, &block
      else
  ...
  class Rejects
    ...
    def add(email, &block)
      _params = {:email => email}
      if block_given?
        @master.call 'rejects/add', _params, &block
      else
    ...
    #             - [Integer] unique_opens the number of unique opens for emails sent for this sender
    #             - [Integer] unique_clicks the number of unique clicks for emails sent for this sender
    def list(email=nil, include_expired=false, &block)
      _params = {:email => email, :include_expired => include_expired}
      if block_given?
        @master.call 'rejects/list', _params, &block
      else
    ...
    def delete(email, &block)
      _params = {:email => email}
      if block_given?
        @master.call 'rejects/delete', _param, &block
      else
        @master.call 'rejects/delete', _param
      end
    end
  ...
  class Inbound
    ...
    def domains( &block)
      _params = {}
      if block_given?
        @master.call 'inbound/domains', _params, &block
      else
    ...
    def routes(domain, &block)
      _params = {:domain => domain}
      if block_given?
        @master.call 'inbound/routes', _params, &block
      else
    ...
    def send_raw(raw_message, to=nil, mail_from=nil, helo=nil, client_address=nil, &block)
      _params = {:raw_message => raw_message, :to => to, :mail_from => mail_from, :helo => helo, :client_address => client_address}
      if block_given?
        @master.call 'inbound/send-raw', _params, &block
      else
  ...
  class Tags
    ...
    def list( &block)
      _params = {}
      if block_given?
        @master.call 'tags/list', _params, &block
      else
    ...
    #     - [Integer] unique_opens the number of unique opens for emails sent with this tag
    #     - [Integer] unique_clicks the number of unique clicks for emails sent with this tag
    def delete(tag, &block)
      _params = {:tag => tag}
      if block_given?
        @master.call 'tags/delete', _params, &block
      else
    ...
    def info(tag, &block)
      _params = {:tag => tag}
      if block_given?
        @master.call 'tags/info', _params, &block
      else
    ...
    #         - [Integer] clicks the number of tracked URLs clicked during the hour
    #         - [Integer] unique_clicks the number of unique clicks generated by messages sent during the hour
    def time_series(tag, &block)
      _params = {:tag => tag}
      if block_given?
        @master.call 'tags/time-series', _params, &block
      else
    ...
    #         - [Integer] clicks the number of tracked URLs clicked during the hour
    #         - [Integer] unique_clicks the number of unique clicks generated by messages sent during the hour
    def all_time_series( &block)
      _params = {}
      if block_given?
        @master.call 'tags/all-time-series', _params, &block
      else
  ...
  class Messages
    ...
    def send(message, async=false, ip_pool=nil, send_at=nil, &block)
      _params = {:message => message, :async => async, :ip_pool => ip_pool, :send_at => send_at}
      if block_given?
        @master.call 'messages/send', _params, &block
      else
    ...
    #         - [String] reject_reason the reason for the rejection if the recipient status is "rejected"
    #         - [String] _id the message's unique id
    def send_template(template_name, template_content, message, async=false, ip_pool=nil, send_at=nil, &block)
      ...
      if block_given?
        @master.call 'messages/send-template', _params, &block
      else
    ...
    def search(query='*', date_from=nil, date_to=nil, tags=nil, senders=nil, limit=100, &block)
      _params = {:query => query, :date_from => date_from, :date_to => date_to, :tags => tags, :senders => senders, :limit => limit}

      if block_given?
        @master.call 'messages/search', _params, &block
      else
    ...
    #         - [Integer] clicks the number of tracked URLs clicked during the hour
    #         - [Integer] unique_clicks the number of unique clicks generated by messages sent during the hour
    def search_time_series(query='*', date_from=nil, date_to=nil, tags=nil, senders=nil, &block)
      _params = {:query => query, :date_from => date_from, :date_to => date_to, :tags => tags, :senders => senders}

      if block_given?
        @master.call 'messages/search-time-series', _params, &block
      else
    ...
    def info(id, &block)
      ...
      if block_given?
        master.call 'messages/info', _params, &block
      else
    ...
    #         - [String] reject_reason the reason for the rejection if the recipient status is "rejected"
    #         - [String] _id the message's unique id
    def send_raw(raw_message, from_email=nil, from_name=nil, to=nil, async=false, ip_pool=nil, send_at=nil, &block)
      ...
      if block_given?
        @master.call 'messages/send-raw', _params, &block
      else
    ...
    def list_scheduled(to=nil, &block)
      _params = {:to => to}

      if block_given?
        @master.call 'messages/list-scheduled', _params, &block
      else
    ...
    #     - [String] to the email's recipient
    #     - [String] subject the email's subject
    def cancel_scheduled(id, &block)
      _params = {:id => id}

      if block_given?
        @master.call 'messages/cancel-scheduled', _params, &block
      else
    ...
    #     - [String] to the email's recipient
    #     - [String] subject the email's subject
    def reschedule(id, send_at, &block)
      _params = {:id => id, :send_at => send_at}

      if block_given?
        @master.call 'messages/reschedule', _params, &block
      else
  ...
  class Whitelists
    ...
    def add(email, &block)
      ...
      if block_given?
        @master.call 'whitelists/add', _params, &block
      else
    ...
    def list(email=nil, &block)
      _params = {:email => email}
      if block_given?
        @master.call 'whitelists/list', _params, &block
      else
    ...
    def delete(email, &block)
      _params = {:email => email}
      if block_given?
        @master.call 'whitelists/delete', _params, &block
      else
  ...
  class Urls
    ...
    def list( &block)
      _params = {}
      if block_given?
        @master.call 'urls/list', _params, &block
      else
    ...
    def search(q, &block)
      _params = {:q => q}
      if block_given?
        @master.call 'urls/search', _params, &block
      else
    ...
    def time_series(url, &block)
      _params = {:url => url}
      if block_given?
        @master.call 'urls/time-series', _params, &block
      else
  ...
  class Webhooks
    ...
    def list( &block)
      _params = {}
      if block_given?
        @master.call 'webhooks/list', _params, &block
      else
    ...
    #     - [Integer] events_sent the total number of events that have ever been sent to this webhook
    #     - [String] last_error if we've ever gotten an error trying to post to this webhook, the last error that we've seen
    def add(url, description=nil, events=[], &block)
      _params = {:url => url, :description => description, :events => events}
      if block_given?
        @master.call 'webhooks/add', _params, &block
      else
    ...
    def info(id, &block)
      _params = {:id => id}
      if block_given?
        @master.call 'webhooks/info', _params, &block
      else
    ...
    #     - [Integer] events_sent the total number of events that have ever been sent to this webhook
    #     - [String] last_error if we've ever gotten an error trying to post to this webhook, the last error that we've seen
    def update(id, url, description=nil, events=[], &block)
      _params = {:id => id, :url => url, :description => description, :events => events}
      if block_given?
        @master.call 'webhooks/update', _params, &block
      else
    ...
    def delete(id, &block)
      _params = {:id => id}
      if block_given?
        @master.call 'webhooks/delete', _params, &block
      else
  ...
  class Senders
    ...
    def list( &block)
      _params = {}
      if block_given?
        @master.call 'senders/list', _params, &block
      else
    ...
    def domains( &block)
      _params = {}
      if block_given?
        @master.call 'senders/domains', _params, &block
      else
    ...
    def info(address, &block)
      _params = {:address => address}
      if block_given?
        @master.call 'senders/info', _params, &block
      else
    ...
    #         - [Integer] clicks the number of tracked URLs clicked during the hour
    #         - [Integer] unique_clicks the number of unique clicks generated by messages sent during the hour
    def time_series(address, &block)
      _params = {:address => address}
      if block_given?
        @master.call 'senders/time-series', _params, &block
      else
